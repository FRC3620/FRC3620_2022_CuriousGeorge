...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    searchForTargetButton.whileHeld(new SearchForTargetCommand(driveSubsystem, visionSubsystem));
    ...
    new TriggerButton(driverJoystick, false).whenPressed(new PullTheTriggerCommand());
  ...
  void setupSmartDashboardCommands() {
    ...
    SmartDashboard.putData("Start Data Logging", new StartShooterDataLoggingCommand("shooter", 120));
  ...
  public void setupAutonomousCommands() {
    ...
    chooser.addOption("2 Ball Steal R", new BloopBlueBallAutoR(driveSubsystem, visionSubsystem, turretSubsystem, intakeSubsystem));
    chooser.addOption("1 Ball Steal", new StealBlueBallAuto(driveSubsystem, visionSubsystem, turretSubsystem, intakeSubsystem));
